...
This is not part of a commercial operation. We have no plans to make money from this operation. We currently have no funding for this work and it is being done very cheaply. The scientific work  was previously funded generously by the British Research Councils (particularly EPSRC) and by Phonak the Swiss hearing aid company.

We are not entering into competition with hearing aid companies but see some potential benefits for everyone with our initiative.
...
h2(#know).  Things you should know before you start

BioAid will continue to run in the background once it is switched on until it is actively switched off. It will continue to run even when the iPhone/iPod is switched off.

BioAid continues to make demands on the battery if switched on (even when the iPhone/iPod is switched off). Remember to switch the application off using the on/off button to the top right of the BioAid home screen.

Bioaid will stop working while you make or take a phone call or if you start to play music with the music app. 
...
# Plug ear phones in to the device but do not put them in your ear yet.
# Set volume control to low using the push buttons on the left of the device
# Launch BioAid by tapping on the BioAid icon
# Switch on BioAid (tap the top left button on the screen; it should change from blue to brown)
# Put the ear pieces into your ear
# Gradually increase the volume level 
# Change the aid setting to suit (see below)
# Keep the ear phones away from the microphone at all times

Closing down sequence

# Switch off BioAid (top left button on the screen; it should change from brown to blue)
# Remove ear pieces

Why follow this procedure?
* Protection from sudden very loud sounds
* Nasty sounding feedback will occur if BioAid is running with no phones plugged in
* The default setting at switch-on (Home page/ button A) is best for setting your starting volume level
...
h2(#bestset). Finding the best setting
...
The slider at the bottom of each page is a ‘noise gate’. Adjust this to reduce electrical noise. You can also use it to block out continuous irritating background noise. Take care as this will also cut out quiet sounds if you move from a noisy to a quiet environment.
...
Do not judge BioAid too hastily. It will take a little getting used to. This is true for all hearing aids. Try sitting quietly on your own, listening to talk radio in a quiet room. 

# Radio is good basis for judging because you are completely dependent on the sound (no lip reading). 
# Talk radio is good because hearing speech is probably the most important thing you do with your ears. Reflect on what you are hearing. Can you make out clearly everything that is being said even when they talk quickly? 
# Smart people can compensate for hearing loss by intelligent guessing. However, over a long period of time, intelligent guessing is hard work. When assessing the different setting ask whether you can listen without effort?
...
h2(#ctrl). Putting the user in control
...
Which is the best approach; fixed settings created by a professional or users choosing what suits them best? Well, that is a research issue. We will not know the answer until we have tried both. Your feedback will help us decide. It may be that people differ. Some want the professional to make all the decisions; others want personal control over all the important things in their lives.





h2(#tech). Some technicalities (for the curious)
...
BioAid is a monaural (one ear) device (not stereo). This is a limitation of the iPhone/ iPod which gives apps access to only one microphone input. BioAid works better when two microphones are used but this is not technically possible with the iPhone/ iPod.
BioAid is not compatible with the use of the telephone facilities or the music player in the device. Again these are limitations imposed by the manufacturer. This makes the iPod the more attractive device to use because it is not affected by telephone intrusions. It is also much cheaper and lighter!

BioAid works in the time domain; it does not use FFT methods. This explains the very low latency of the device (around 7/1000 of a second). It is important to work in the time domain so that we can achieve instantaneous compression to protect against sudden very loud sounds.
...
h2(#fback). How you can help us and others
...
While the project is finding its feet, please visit the "contacts page":contact.html for information on how you can give us your feedback. If you try it and don’t like it, we will still appreciate hearing from you particularly if you can say why you don’t like it!
